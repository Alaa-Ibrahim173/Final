...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230127_khotwh_754f42f6e5e7199c8140_20230127091451_archive.zip';
        const ARCHIVE_SIZE       = '72986870';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '754f42f-27091451';
        const SECONDARY_PACKAGE_HASH = '24e8633-27091451';
        const VERSION            = '1.5.2';
